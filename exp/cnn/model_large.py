...
def get_model(input_images, is_training, cat_num, batch_size, weight_decay, bn_decay):
    ...
    net = slim.dropout(input_data, is_training=is_training, keep_prob=0.8, scope='convdp0')

    net = tf_util.conv2d(net, 64, [3, 3], stride=[1, 1], padding='SAME', scope='conv1', \
    ...
    net = slim.dropout(net, is_training=is_training, keep_prob=0.8, scope='convdp1')
    print net
    ...
    net = slim.dropout(net, is_training=is_training, keep_prob=0.8, scope='convdp2')
    print net
    ...
    net = slim.dropout(net, is_training=is_training, keep_prob=0.8, scope='convdp3')
    print net
    ...
    net = slim.dropout(net, is_training=is_training, keep_prob=0.8, scope='convdp4')
    print net
